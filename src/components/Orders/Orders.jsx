    ...
    >
      <Form className={s.filters} action="submit">
        <div className={s.filters__leftCol}>
          <Field name="example" component={SelectFilter} options={options} placeholder="Период" />
          <Field name="example2" component={SelectFilter} options={options} placeholder="Модель" />
          <Field name="example3" component={SelectFilter} options={options} placeholder="Город" />
          <Field name="example3" component={SelectFilter} options={options} placeholder="Статус" />
        </div>
